...
namespace Giveaway.SteamGifts.Commands
{
    ...
    internal class StartCommand : BaseCommand
    {
        ...
        {
            var webNavigator = new WebNavigator();
            try
            {
                webNavigator.Start();
                ...
                CombinedLogger.LogInfo("Имя пользователя: " + giveawayPage.GetUserName() + "\nУровень" + giveawayPage.GetLevel() + "\n" + "Баланс: " + giveawayPage.GetPoints());
        ...
        public void ProcessGiveaway(GiveawayElement giveaway)
        {
            ...
            if (filtered)
            {
                ...
                TelegramService.SendMessage(GetGameTelegramMessage(giveaway, gameInfo), successEntered);
        ...
        private bool FilterGame(GiveawayElement giveawayElement, out SteamGameInfo gameData)
        {
            ...
            if (gameData == null)
                return false;
            if (gameData.Raiting > FilterSettings.MinRatingForEnter && gameData.TotalReviews > FilterSettings.MinRatingForEnter)
                return true;
            return false;
        }
        ...
        private string GetGameTelegramMessage(GiveawayElement giveawayElement, SteamGameInfo gameInfo)
        {
            ...
            telegramMessage.Append($" <a href =\"{giveawayElement.GiveawayUrl}\">Giveaway</a>");
